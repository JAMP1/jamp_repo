...
<html>
  ...
  <body class="laboratorix text-pag">
    <div class="container">
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
              ...
              <li><a href="/JAMP/vistaEditorial.php">Administrar Editoriales</a></li>
              <li class="active"><a href="">Modificar Editorial</a></li>
          </ul>
        </div><!-- /.navbar-collapse -->
        </div>
      </nav><br><br><br>
      <div class="row">
       <div class="col-md-12">
      <form class="formulario" method="POST" action="entidadController.php?action=confirmarModificacionEditorial" onSubmit="return confirmar()">
      <table class="table table-bordered" border="">
          <tr>
          <td><p>Nombre</p>
          </td>
          </tr>
        <td><input name="nom_editorial" type="text" placeholder="<?php echo $n;?>" required="required"/></td>
        </tr>
      </table>
