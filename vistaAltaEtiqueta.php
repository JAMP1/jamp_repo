      ...
      <div class="col-md-8">
        <div class="panel panel-info">
          <div class="panel-heading">
            <h3 class="panel-title">Alta de etiqueta</h3>
          </div>
              ...
              <tr>
                <td>
                  <div class="input-group input-group-lg">
                    ...
                    <input class="form-control" id="nombre" type="text" placeholder="Ingrese nombre etiqueta" name="nom_etiqueta" required="required">
                  </div>
                </td>
              </tr>
              <td>
