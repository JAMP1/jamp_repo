...
<html>
  ...
  <body class="laboratorix text-pag">
    <!--<div class="container">-->
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
              ...
              <li><a href="/JAMP/PORTI/entidadController.php?action=cargarEtiqueta">Administrar Etiquetas</a></li>
      ...
      <div class="row">
       <div class="col-md-12">
      <form class="formulario" method="POST" action="entidadController.php?action=confirmarModificacionEtiqueta" onSubmit="return validar()">
