...
<html>
  ...
  <body class="laboratorix text-pag">
    <div class="container">
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
              ...
              <li><a href="/JAMP/vistaEtiquetas.php">Administrar Etiquetas</a></li>
      ...
      <div class="row">
       <div class="col-md-12">
      <form class="formulario" method="POST" action="entidadController.php?action=confirmarModificacionEtiqueta" onSubmit="return confirmar()">
      <table class="table table-bordered" border="">
          <tr>
          <td><p>Nombre</p>
          </td>
          </tr>
        <td><input name="nom_etiqueta" type="text" placeholder="<?php echo $n;?>" required="required"/></td>
        </tr>
      </table>
      ...
      <a href="entidadController.php?action=cargarEtiqueta">Volver</a>
      </div>
      </div>
    </div>
  </body>
