...
<nav class="navbar navbar-inverse" role="navigation">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href ="/JAMP/PORTI/llamadaController.php?action=publicoInicio&clase=entidad"> Inicio </a></li>
      </ul>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="active"><a href="#">Olvide mi contraseña</a></li>
      </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>
  ...
  <div class="jumbotron">
    <div class="container">
      <?php
        if(isset($noEstaBienEmail)){
          echo "<div class='alert alert-danger'>Error! No concuerda el email ingresado</div>";
        }
        if(isset($noExisteUsuario)){
          echo "<div class='alert alert-danger'>Error! No existe el usuario ingresado!</div>"; 
        }
      ?>
    </div>
    <div class="container">
      <h2>Recuperacion de contraseña</h2>
      <h3>Ingrese usuario y email, para que se le envie un correo con los instructivos para recuperar su contrasena</h3>
    </div>
    <br>
    <form method="POST" onSubmit="return validarRecuperaEmail()" action="/JAMP/PORTI/llamadaController.php?action=recuperarContrasena&clase=entidad">
      <td>
