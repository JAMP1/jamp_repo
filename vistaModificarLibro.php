              ...
              <td>
                <div class="input-group input-group-lg">
                  <span class="input-group-addon">Detalle/Descripcion</span>
                    <?php
                      if(isset($detalle)){
                        echo "<textarea  class='form-control' name='detalle_libro' id='detalle_libro' >".$detalle."</textarea>";
                      }else{
                        echo "<textarea  class='form-control' name='detalle_libro' id='detalle_libro' >".$libro[0]['detalle_libro']."</textarea>";
                      }
                    ?>
                </div>
              </td>
